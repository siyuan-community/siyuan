...
const (
	githubReleasesURL            = "https://api.github.com/repos/siyuan-community/siyuan/releases?per_page=100"
	githubReleaseURLPrefix       = "https://github.com/siyuan-community/siyuan/releases/tag/v"
...
func getStablePackageURLs(version, pkgName string) []string {
	githubURL := "https://github.com/siyuan-community/siyuan/releases/download/v" + strings.TrimPrefix(version, "v") + "/" + pkgName
...
func currentInstallPackageName(version string) string {
	...
	return "siyuan-CE-v" + strings.TrimPrefix(version, "v") + "-" + suffix
}
